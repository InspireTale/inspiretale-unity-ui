...
namespace InspireTale.UI
{
    ...
    public class AdjustWannayuk : EditorWindow
    {
        ...
        static float wannayukHeight = 12f;
        ...
        {
            GetWindow(typeof(AdjustWannayuk));
        }
        ...
        static void DoAdjust(TMP_FontAsset fontAsset)
        {
            if (fontAsset == null)
            {
            ...
            foreach (var sara in saras)
            {
                foreach (var wannayuk in wannayuks)
                {
                    ...
                    TMP_GlyphValueRecord saraPosition = new(0, 0, 0, 0);
                    TMP_GlyphAdjustmentRecord saraGlyph = new((uint)sara, saraPosition);

                    TMP_GlyphValueRecord wannayukPosition = new(xPlacement, wannayukHeight, 0, 0);
                    TMP_GlyphAdjustmentRecord wannayukGlyph = new((uint)wannayuk, wannayukPosition);
        ...
        static void DoClear(TMP_FontAsset fontAsset)
        {
